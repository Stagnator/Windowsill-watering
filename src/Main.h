...
//Pins definitions
static constexpr int pinOfSensor[NB_OF_PUMPS] = { A0, A1, A2 };        //Pins connected to capacity sensors 1-2-3
static constexpr int pinOfPump[NB_OF_PUMPS] = { A3, A6, A7 };          //Pins connected to pump relays 1-2-3
